...
## Corpus Check
- 34 files · ~4,198,370 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 558 nodes · 708 edges · 82 communities (48 shown, 34 thin omitted)
- Extraction: 89% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 73 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `904d2e75`
...
- **Why does `AgentBridge._handle_line (command dispatch)` connect `Community 71` to `Community 67`, `Community 68`, `Community 69`, `MCP Server Bridge`, `Server-Auth Co-op Netcode`, `Community 56`?**
...
- **Why does `Events Bus` connect `Community 56` to `AgentBridge QA Commands`?**
